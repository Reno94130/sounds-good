export default function Film() {
  return (
    <section id="film" className="bg-[#fff3e2] py-20 text-[#17110d] md:py-28">
      <div className="mx-auto max-w-7xl px-5 md:px-14">
        ...
        <div className="mb-12 grid gap-8 md:grid-cols-[0.9fr_1.1fr] md:items-end">
          ...
          <div className="border-l-4 border-[#ff5a1f] pl-6">
            <p className="max-w-xl text-xl font-semibold leading-8 tracking-[-0.02em] text-[#17110d] md:text-2xl md:leading-9">
        ...
        <div className="relative border-l-4 border-[#ff5a1f] pl-4 md:pl-6">
          <div className="relative aspect-video overflow-hidden border-2 border-[#17110d] bg-black shadow-[14px_14px_0_#ff5a1f]">
            <iframe
